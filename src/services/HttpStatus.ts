export class HttpStatus {
  ...
  static readonly SWITCHING_PROTOCOLS = new HttpStatus(
    'Switching Protocols',
    101,
  );
  ...
  static readonly NON_AUTHORITATIVE_INFORMATION = new HttpStatus(
  ...
  static readonly TEMPORARY_REDIRECT = new HttpStatus(
    'Temporary Redirect',
    307,
  );
  ...
  static readonly METHOD_NOT_ALLOWED = new HttpStatus(
    'Method Not Allowed',
    405,
  );
  static readonly NOT_ACCEPTABLE = new HttpStatus('Not Acceptable', 406);
  static readonly PROXY_AUTHENTICATION_REQUIRED = new HttpStatus(
  ...
  static readonly PRECONDITION_FAILED = new HttpStatus(
    'Precondition failed',
    412,
  );
  static readonly REQUEST_ENTITY_TOO_LARGE = new HttpStatus(
    'Request Entity Too Large',
    413,
  );
  static readonly REQUEST_URI_TOO_LONG = new HttpStatus(
    'Request-URI Too Long',
    414,
  );
  static readonly UNSUPPORTED_MEDIA_TYPE = new HttpStatus(
    'Unsupported Media Type',
    415,
  );
  static readonly REQUESTED_RANGE_NOT_SATISFIABLE = new HttpStatus(
    'Requested Range Not Satisfiable',
    416,
  );
  static readonly EXPECTATION_FAILED = new HttpStatus(
    'Expectation Failed',
    417,
  );
  static readonly INSUFFICIENT_SPACE_ON_RESOURCE = new HttpStatus(
    'Insufficient Space on Resource',
    419,
  );
  static readonly METHOD_FAILURE = new HttpStatus('Method Failure', 420);
  static readonly DESTINATION_LOCKED = new HttpStatus(
    'Destination Locked',
    421,
  );
  ...
  static readonly SERVICE_UNAVAILABLE = new HttpStatus(
    'Service Unavailable',
    503,
  );
  static readonly GATEWAY_TIMEOUT = new HttpStatus('Gateway Timeout', 504);
  static readonly HTTP_VERSION_NOT_SUPPORTED = new HttpStatus(
    'HTTP Version Not Supported',
    505,
  );
  static readonly VARIANT_ALSO_NEGOTIATES = new HttpStatus(
    'Variant Also Negotiates',
    506,
  );
  static readonly INSUFFICIENT_STORAGE = new HttpStatus(
